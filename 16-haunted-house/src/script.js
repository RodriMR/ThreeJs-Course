...
//Tomb
const tombColorTexture = textureLoader.load(
  "./tomb/plastered_stone_wall_1k/plastered_stone_wall_diff_1k.jpg"
);
const tombARMTexture = textureLoader.load(
  "./tomb/plastered_stone_wall_1k/plastered_stone_wall_arm_1k.jpg"
);
const tombNormalTexture = textureLoader.load(
...
tombColorTexture.wrapS = THREE.RepeatWrapping;
tombARMTexture.wrapS = THREE.RepeatWrapping;
tombNormalTexture.wrapS = THREE.RepeatWrapping;
 ...
 */
// Ambient light
const ambientLight = new THREE.AmbientLight("#437a99", 0.5);
scene.add(ambientLight);

// Directional light
const directionalLight = new THREE.DirectionalLight("#437a99", 1.5);
directionalLight.position.set(3, 2, -8);
scene.add(directionalLight);

//Door Light
const doorLight = new THREE.PointLight("rgba(155, 0, 0, 1)", 5);
...
sky.material.uniforms["turbidity"].value = 400;
sky.material.uniforms["rayleigh"].value = 4;
sky.material.uniforms["mieCoefficient"].value = 0.1;
sky.material.uniforms["mieDirectionalG"].value = 0.95;
sky.material.uniforms["sunPosition"].value.set(0.3, -1, -0.95);
/**
 * Fog
 */
